<footer class="ftco-footer bg-bottom ftco-no-pt" style="background-image: url('{{ asset('clients/images/bg_3.jpg')}}');">
	<div class="container">
		<div class="row mb-5">
			<div class="col-md pt-5">
				<div class="ftco-footer-widget pt-md-5 mb-4">
					<h2 class="ftco-heading-2">Giới Thiệu</h2>
					<p>Chúng tôi mang đến những hành trình tuyệt vời, an toàn và đáng nhớ cho mọi du khách. Hãy cùng khám phá thế giới và tạo nên những kỷ niệm đẹp cùng chúng tôi.</p>

<ul class="wrapper">
  <li class="icon facebook">
	 <a href="https://www.facebook.com/viet.loc.625965?locale=vi_VN" target="_blank">
  ...
  <li class="icon instagram">
    ...
    >
      ...
      ></path>
			...
			<div class="col-md pt-5 border-left">
				<div class="ftco-footer-widget pt-md-5 mb-4 ml-md-5">
					...
					<ul class="list-unstyled">
						...
						<li><a href="#" class="py-2 d-block">Câu hỏi chung</a></li>
					...
					<div class="block-23 mb-3">
						<ul>
							<li>
								...
								<span class="text">203 Đường ABC, Quận XYZ, TP.HCM, Việt Nam</span>
							</li>
							<li>
								<a href="#">
			...
			<div id="ftco-loader" class="show fullscreen globe-loader">
				<!-- From Uiverse.io by faheemmehdi --> 
<div class="loader"></div>
			...
			<script src="{{asset('clients/js/bootstrap-datepicker.js')}}"></script>
