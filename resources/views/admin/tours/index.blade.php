...
@section('content')
    <div class="flex flex-wrap items-center justify-between gap-3">
        <div>
            ...
            <h1 class="text-2xl font-semibold tracking-tight">Tours</h1>
        </div>
    ...
    <x-admin.card>
        <form method="GET" class="grid gap-3 md:grid-cols-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.tours.index') }}" class="btn-ghost">Đặt lại</a>
            </div>
        </form>
    </x-admin.card>
                    ...
                    <tr class="table-row">
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-3">
                                <div class="h-12 w-16 overflow-hidden rounded-xl bg-slate-100 dark:bg-slate-800">
                                    <img src="{{ $tour->thumbnail_url }}" class="h-full w-full object-cover" alt="{{ $tour->name }}">
                                </div>
                                <div>
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="flex justify-end gap-2">
                                <a href="{{ route('admin.tours.edit', $tour) }}" class="btn-ghost" title="Sửa">Sửa</a>
